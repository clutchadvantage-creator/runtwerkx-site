  ...
  return (
    <section id="about" className="mx-auto max-w-7xl px-6 py-20">
      <div className="grid gap-10 md:grid-cols-[0.95fr_1.05fr] md:items-start">
        <div>
          <p className="text-sm font-semibold uppercase tracking-[0.3em] text-green-400">⇼ About ⇼</p>
          <h2 className="mt-3 text-3xl font-bold md:text-4xl">Humble Beginnings</h2>
          ...
          <div className="group relative mt-8 h-[340px] w-full overflow-hidden rounded-[1.75rem] border border-green-500/20 bg-black/50 shadow-[0_0_35px_rgba(34,197,94,0.08)] md:h-[460px]">
            ...
            <div className="absolute inset-x-0 bottom-0 p-6">
              <div className="inline-flex rounded-full border border-green-400/20 bg-black/45 px-4 py-2 text-[11px] font-semibold uppercase tracking-[0.28em] text-green-300 backdrop-blur">
